...
class ScriptTestsCommon {
    ...
    fun p2pkh() {
        ...
        assertEquals("MJzaqUqRaWTiWibfSZRr8rSznjisRVWXD7", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
    ...
    fun p2sh() {
        ...
        assertEquals("PLYnnZLeMrqigRiB1tnL8qcgnu84qH4BVj", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
    ...
    fun p2wpkh() {
        ...
        assertEquals("mona1q0xcqpzrky6eff2g52qdye53xkk9jxkvrnfj4f0", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
    ...
    fun p2wsh() {
        ...
        assertEquals("mona1qdudnf8tla4fyptt3n9y9985tq64lqwzr37d4ywpqfzfhtt638glsfmqchw", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
    ...
    fun `future segwit versions`() {
        ...
        assertEquals("mona1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqtsd8k8", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
